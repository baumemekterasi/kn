          ...
          <div className="section-card">
            ...
            <div className="section-body grid gap-2.5">
              <Field label="Tarif PPN (%)">
                <input type="number" data-testid="settings-ppn-rate" className="field tabular-nums" value={tax.ppn_rate ?? 12}
                  onChange={(e) => setSection("tax", "ppn_rate", parseFloat(e.target.value) || 0)} />
              </Field>
              <Toggle label="DPP Nilai Lain 11/12 (Coretax — PPN efektif 11%)" testid="settings-dpp-nilai-lain"
                checked={!!tax.dpp_nilai_lain} onChange={(v) => setSection("tax", "dpp_nilai_lain", v)} />

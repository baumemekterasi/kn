...
import {
  ...
  RotateCcw, ClipboardCheck, ShieldCheck, CreditCard,
} from "lucide-react";
...
const KIND_META = {
  so_nilai:         { label: "SO · Nilai Order",  icon: ShieldCheck,    fg: "#4F46E5", bg: "#EEF0FF", group: "sales_order" },
...
export default function ApprovalInbox({ currentUser, onNavigate, onOpenDocument }) {
  ...
  async function load() {
    setLoading(true);
    try {
      const [queueRes, poRes, prRes, srRes, purRes, ccRes] = await Promise.all([
        ...
        <div className="section-head">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] text-[#6B6B73]">Semua persetujuan yang menunggu keputusan Anda — Sales Order (nilai/kredit/harga), PO, retur & cycle count.</p>
            </div>
          </div>

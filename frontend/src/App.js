...
import GroupConsolidationView from "./features/finance/GroupConsolidationView";
import FinancialStatementsView from "./features/finance/FinancialStatementsView";
import ClosingView from "./features/finance/ClosingView";
import BiFinanceView from "./features/finance/BiFinanceView";
import TaxCenterView from "./features/finance/TaxCenterView";
import DetailDrawer from "./components/DetailDrawer";
import TourMenu from "./components/TourMenu";
import OnboardingPanel from "./components/OnboardingPanel";
import EntitySwitcher from "./components/EntitySwitcher";
import NotificationCenter from "./components/NotificationCenter";
import { PAGE_META, GUIDANCE_MAP, buildNavGroups, defaultNavIdForRole, defaultViewForRole, resolveActiveNavId, hubForView } from "./config/navigationConfig";
...
import EmployeesView from "./features/hr/EmployeesView";
import OrgUnitsView from "./features/hr/OrgUnitsView";
import EmployeeSelfService from "./features/hr/EmployeeSelfService";
import AttendanceView from "./features/hr/AttendanceView";
import AttendanceSetupView from "./features/hr/AttendanceSetupView";
import LiveTrackingView from "./features/hr/LiveTrackingView";
import VisitsView from "./features/hr/VisitsView";
import PayrollRunsView from "./features/hr/PayrollRunsView";
import PayslipsView from "./features/hr/PayslipsView";
import PayrollSetupView from "./features/hr/PayrollSetupView";
import LeaveView from "./features/hr/LeaveView";
import OvertimeView from "./features/hr/OvertimeView";
import KpiView from "./features/hr/KpiView";
import DesignGalleryView from "./features/hr/DesignGalleryView";
import HrAnalyticsView from "./features/hr/HrAnalyticsView";
import StockAnalyticsView from "./features/inventory/StockAnalyticsView";
import LocationPutawayView from "./features/wms/LocationPutawayView";
import RfidTagsView from "./features/rfid/RfidTagsView";
import RfidDevicesView from "./features/rfid/RfidDevicesView";
import RfidGateMonitorView from "./features/rfid/RfidGateMonitorView";
import RfidLocationsView from "./features/rfid/RfidLocationsView";
import {
  Archive,
  Boxes,
  Building2,
...
function App() {
  ...
  // cs-* = konvensi "coming soon", KECUALI yang sudah live (punya route nyata). FASE H5.
  const LIVE_CS_VIEWS = ["cs-kpi", "cs-design-gallery", "cs-bi-hrd", "cs-pajak", "cs-stock-analytics",
    "cs-rfid-lokasi", "cs-rfid-tags", "cs-rfid-devices", "cs-rfid-gate"];
  const isComingSoon = typeof activeView === "string" && activeView.startsWith("cs-") && !LIVE_CS_VIEWS.includes(activeView);
    ...
    <div className={`app-shell layout-grid ${sidebarCollapsed ? "sidebar-hidden" : ""}`}>
      ...
      <div className="app-main">
        <TopBar
          ...
          entitySwitcher={<EntitySwitcher entities={switcherEntities} value={selectedEntity} onChange={onSelectEntity} canSwitch={canSwitchEntity} role={user?.role} />}
          notificationCenter={
            <NotificationCenter
              notifications={notifications}
              unreadCount={unreadCount}
          ...
          <div className="mt-4 md:mt-5">
            {hubInfo && (
              <HubTabs
                ...
                tabs={hubInfo.tabs}
                activeView={activeView}
                onSelect={(view, tab) => handleNavSelect(hubInfo.hubId, view, tab)}
              />
            )}
            ...
            {activeView === "approval-inbox" && <ApprovalInbox currentUser={user} onNavigate={(navId, view, tab) => handleNavSelect(navId, view, tab)} onOpenDocument={openDocument} />}
            ...
            {activeView === "hr-payroll-setup" && <PayrollSetupView currentUser={user} />}
